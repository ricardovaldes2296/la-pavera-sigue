    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-6">
      <div className="bg-zinc-900 w-full max-w-sm border border-zinc-800 p-6 shadow-2xl">
        <div className="flex justify-between items-center mb-6">
          <h2 className="font-serif italic text-2xl text-white flex items-center gap-2"><Clock size={20} className="text-gold-500" /> Tu Historial</h2>
        ...
        <div className="mt-6 pt-4 border-t border-zinc-800 text-center">
            <p className="text-[10px] uppercase tracking-widest text-zinc-600">Total consumido: <span className="text-gold-500 font-bold">{history.length}</span></p>
        </div>
      </div>
    </div>
  );
